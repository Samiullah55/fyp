            ...
            <div className="row">
              <div className="image">
                ...
                <div className="bgtext">
                  ...
                  <p className="welcome">
                    Pakistan largest ever plantation drive
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="container mt-5">
              <div className="col-md-6 ">
                ...
                <p>
                  ...
                  wildlife units. The Ministry of Climate Change is overseeing
                  the program coordination, execution, supervision, and overall
                  delivery of the program outputs and activities.
                  <br />
                  Reports suggest that Pakistan is among the most vulnerable
                  countries on the Global Climate Index which has been
                  recurrently impacted by catastrophes, made worse by the
                  deteriorating climate conditions.
                </p>
              </div>
              <div className="container col-md-6">
                <div className="about col-md-4 mt-5">
                  <img src={b} className="img-fluid" alt="img" />
                </div>
                <div className="about col-md-4">
                  <img src={c} className="img-fluid" alt="img" />
                </div>
                <div className="about col-md-4 mt-3">
                  <img src={a} className="img-fluid" alt="img" />
                </div>
              </div>
            </div>
            ...
            <div className="sec4 mt-5">
              ...
              <div className=" container subsec4">
                <div className="col-md-3" data-aos="fade-right">
                  <img className="imgs img-fluid" src={sec41} alt="img" />
                  <h3>
                ...
                <div className="col-md-3">
                  <img className="imgs img-fluid" src={sec44} alt="img" />
                  <h3>
                    Biodiversity <br />
                    Conservation
                  </h3>
                ...
                <div className="col-md-3">
                  <img className="imgs img-fluid" src={sec43} alt="img" />
                  <h3>
                    Protected Areas <br />
                    Initiative
                  </h3>
